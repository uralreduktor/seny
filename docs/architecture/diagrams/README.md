...
1. **tender_management_flow.puml** — поток данных модуля управления торгами
2. **pricing_kb_ai_flow.puml** — поток данных модуля базы знаний
3. **docflow_flow.puml** — поток данных модуля подготовки документации

### Диаграммы данных

1. **database_schema.puml** — схема базы данных
2. **entity_relationship.puml** — ER-диаграмма

### Диаграммы AI компонентов

1. **rag_pipeline.puml** — RAG pipeline
2. **ocr_pipeline.puml** — OCR pipeline

### Диаграммы последовательности

1. **search_similar_sequence.puml** — последовательность поиска похожих расчётов
2. **generate_tkp_sequence.puml** — последовательность генерации ТКП
3. **ocr_processing_sequence.puml** — последовательность обработки чертежа
